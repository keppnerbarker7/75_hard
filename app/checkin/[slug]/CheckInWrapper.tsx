      ...
      {canCorrectYesterday && (
        <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              <p className="text-sm font-semibold text-blue-900 mb-1">
                {yesterdayCheckIn?.isAutoFilled ? "Correction Window Active" : "Update Yesterday's Entry"}
              </p>
              <p className="text-sm text-blue-700">
                {yesterdayCheckIn?.isAutoFilled
                  ? "You missed yesterday's check-in. You have until midnight tonight to correct it."
                  : "Finished tasks after midnight? You can update yesterday's check-in until midnight tonight."
                }
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={`flex-1 px-4 py-2 rounded-lg font-medium text-sm transition-all ${
                selectedDay === "yesterday"
                  ? yesterdayCheckIn?.isAutoFilled ? "bg-amber-600 text-white shadow-md" : "bg-blue-600 text-white shadow-md"
                  : yesterdayCheckIn?.isAutoFilled
            ...
            >
              Yesterday {yesterdayCheckIn?.isAutoFilled ? "(Correct)" : "(Update)"}
            </button>
          </div>
        </div>
      )}
